...
df, test_xki, test_xpc, test_xmc, test_xmg, maxpc = dataset.load_datasets(args, test=True)
...
for load_result, model_name in zip(load_results, load_models):
    ...
    args.ki_n_conv1d = result_df['ki_n_conv1d'].iloc[0]
    ...
    args.ki_n_attention = result_df['ki_n_attention'].iloc[0]
