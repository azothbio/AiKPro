...
def load_datasets(args, test=False):
    ...
    if not test:
        return df, xki, xpc, xmc, xmg, ytg, pc_factor
    else:
        return df, xki, xpc, xmc, xmg, pc_factor

def make_datasets(args, df, xki, xpc, xmc, xmg, ytg, pc_factor):
    ...
    train_data = [train_xki, train_xpc, train_xmc, train_xmg, train_ytg]
    ...
    test_data = [test_xki, test_xpc, test_xmc, test_xmg, test_ytg]
...
def make_kfold_datasets(args, kfold, k, df, xki, xpc, xmc, xmg, ytg, pc_factor):
