...
def experiment(args, train_data, test_data):
    ...
    train_xki, train_xpc, train_xmc, train_xmg, train_x3d, train_ytg = train_data
    test_xki, test_xpc, test_xmc, test_xmg, test_x3d, test_ytg = test_data
    ...
    history = kpro.fit([train_xki, train_xpc, train_xmc, train_xmg, train_x3d], train_ytg, 
                       epochs=args.epochs,
                       batch_size=args.batch,
                       validation_data=([test_xki, test_xpc, test_xmc, test_xmg, test_x3d], test_ytg), 
